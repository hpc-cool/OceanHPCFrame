...
!   public :: wav_mpi_isend ,wav_mpi_irecv
   ...
   interface wav_mpi_bcast ; module procedure &
     ...
     wav_mpi_bcastf0 , wav_mpi_bcastf1, wav_mpi_bcastf2 , &
     wav_mpi_bcastp 
   end interface
...
! ===============================================================================
SUBROUTINE wav_mpi_bcastf0(vec,root_,string)
   ! ----- arguments ---
   real(4),    intent(inout):: vec      ! vector of 1
   integer,optional::root_
   character(*),optional,intent(in)   :: string   ! message
...
! -------------------------------------------------------------------------------
   ...
   call MPI_BCAST(vec,lsize,MPI_REAL,root,mpi_comm_wav,ierr)
   call wav_mpi_chkerr(ierr,subName,string)

END SUBROUTINE wav_mpi_bcastf0

! ===============================================================================
! ===============================================================================

SUBROUTINE wav_mpi_bcastf1(vec,root_,string)
   ! ----- arguments ---
   real(4),    intent(inout):: vec(:)   ! vector
   integer,optional::root_
   character(*),optional,intent(in)   :: string   ! message

   ! ----- local ---
   character(*),parameter             :: subName = '(wav_mpi_bcastf1) '
   integer  :: ierr,lsize,root
   root=0;if(present(root_))root=root_
...
END SUBROUTINE wav_mpi_bcastf1
SUBROUTINE wav_mpi_bcastf2(vec,root_,string)
   ! ----- arguments ---
   real(4),    intent(inout):: vec(:,:)   ! vector
   integer,optional::root_
   character(*),optional,intent(in)   :: string   ! message
...
END SUBROUTINE wav_mpi_bcastf2
